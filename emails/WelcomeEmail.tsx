        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.section}>
            ...
            <Text style={styles.small}>
              This link expires in 24 hours. If it has expired, please contact us at ray.ankrah@eranoconsulting.com or via WhatsApp and we will send you a new activation link.
            </Text>
            <Text style={styles.small}>
