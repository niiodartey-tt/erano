...
const schema = z.object({
  ...
  payment_date:          z.string().min(1, "Date is required").refine(
  ...
  file: z.any()
    ...
    .refine(
      (val) => !(val instanceof FileList) || ["image/jpeg", "image/png", "application/pdf"].includes(val[0].type),
      "Only PDF, JPEG, or PNG are accepted",
    ),
});
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      <div className="mb-4">
        ...
        <input id="bank_name" type="text" {...register("bank_name")} className={inputCls} />
      ...
      <button
        ...
        className="flex items-center gap-2 rounded bg-navy px-6 py-2.5 text-sm font-semibold text-gold disabled:cursor-not-allowed disabled:opacity-50"
      >
